...
// Copyright (c) 2011-2012 UltimateBitcoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("UltimateBitcoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #UltimateBitcoinTEST0\r");
            Send(hSocket, "WHO #UltimateBitcoinTEST0\r");
        } else {
            // randomly join #UltimateBitcoin00-#UltimateBitcoin99
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #UltimateBitcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #UltimateBitcoin%02d\r", channel_number).c_str());
        }
